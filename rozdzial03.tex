...
Wymagania aplikacji dziel¹ siê na funkcjonalne i niefunkcjonalne. Pierwsze z nich okreœlaj¹ mo¿liwoœci zapewniane u¿ytkownikowi, je¿eli aplikacja prawid³owo dzia³a. Drugie przedstawiaj¹ mo¿liwoœci wynikaj¹ce z jej budowy. Definiuj¹ one funkcje zwi¹zane z bezpieczeñstwem, wydajnoœci¹ i wygod¹ korzystania z aplikacji. Nastêpne podrozdzia³y wymieniaj¹ funkcjonalnoœci zawarte w projekcie.  
...
\begin{itemize}[leftmargin=1cm]
	\item Mo¿liwoœæ korzystania z funkcji aplikacji po ówczesnym zalogowaniu siê za wyj¹tkiem tworzenia konta
	\item Na jednym urz¹dzeniu mo¿e byæ zalogowany jeden u¿ytkownik
	\item Personalne informajce widoczne tylko dla ich w³aœciciel
\end{itemize}
