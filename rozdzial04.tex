...
Na podstawie wykonanego audytu zlokalizowano kilka s³aboœci aplikacji. Dla funkcji logowania nie znaleziono podatnoœci, natomiast nie posiada ona limitu logowañ w danym zakres czasu. Nara¿a j¹ to na przyjmowanie bardzo du¿ej iloœci ¿¹dañ od klienta w krótkim przedziale czasu, co mo¿e spowodowaæ zwolnienie dzia³ania lub jej ca³kowite wy³¹czenie siê. Podczas tworzenia konta nie wszystkie pola posiadaj¹ sprawdzanie poprawnoœci wprowadzonych wartoœci. Dodatkowo funkcja nie weryfikuje, czy u¿ytkownik o wpisanym loginie ju¿ istnieje w bazie. Obie podatnoœci wp³ywaj¹ krytycznie na dzia³anie aplikacji, poniewa¿ j¹ wy³¹czaj¹. Niezanotowano równie¿ ¿adnych minimalnych wymagañ co do jakoœci has³a takich jak: du¿a litera, znak specjalny, cyfra. Dane przy audytowanych funkjonalnoœciach przesy³ane s¹ miêdzy klientem a serwerem aplikacji jawnie. U¿ywaj¹ one protok³u HTTP (ang.~\emph{Hypertext Transfer Protocol}), który ich nie szyfruje i nie korzysta z certyfikatu SSL (ang.~\emph{Secure Sockets Layer}).   