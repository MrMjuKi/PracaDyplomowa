...
\begin{figure}[htb]
\centering
\includegraphics[scale=0.36]{Rys03/Success.png}
...
label={lst:Podstawa programu}, basicstyle=\footnotesize\ttfamily]
...
\begin{lstlisting}[language=Python, caption=Funkcja wykonywana po wejœciu na podstronê /rejestracja, label={lst:rejestracja}, basicstyle=\footnotesize\ttfamily]
...
\begin{lstlisting}[language=Python, caption=Funkcja wykonywana po wejœciu na podstronê /logowanie, label={lst:logowanie}, basicstyle=\footnotesize\ttfamily]
...
\begin{lstlisting}[language=Python, caption=Funkcja wykonywana po wejœciu na podstrone /dodajOferte, label={lst:dodajOferte}, basicstyle=\footnotesize\ttfamily]
def dodawanieOferty():
    if not session:
...
\begin{lstlisting}[language=Python, caption=Funkcja wykonywana po wejœciu na podstrone /mojeOferty, label={lst:mojeOferty}, basicstyle=\footnotesize\ttfamily]
def mojeoferty():
    if not session:
...
\begin{lstlisting}[language=Python, caption=Funkcja wykonywana po wejœciu na podstrone /mojeDane, label={lst:mojeDane}, basicstyle=\footnotesize\ttfamily]
...
\begin{lstlisting}[language=Python, caption=Funkcja wykonywana po wejœciu na podstrone /wyloguj, label={lst:wyloguj}, basicstyle=\footnotesize\ttfamily]
@app.route('/wyloguj')
def wyloguj():
    if not session:
...
\begin{lstlisting}[language=Python, caption=Funkcja wykonywana po wejœciu na strone g³ówn¹ lub po za³adowaniu podstawy programu, label={lst:home}, basicstyle=\footnotesize\ttfamily]
